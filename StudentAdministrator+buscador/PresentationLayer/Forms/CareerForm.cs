...
namespace PresentationLayer.Forms
{
    public partial class CareerForm : Form
    {
        ...
        public CareerForm()
        {
            ...
            InitializeComponent();
            LoadCareerData(string.Empty);
        }

        private void LoadCareerData(string searchCareer)
        {
            dgvCareers.DataSource = _careerService.GetAllCareers(searchCareer);
        }
        ...
        private void txtSearchCareer_TextChanged(object sender, EventArgs e)
        {
            LoadCareerData(txtSearchCareer.Text);
        }
    }
}
